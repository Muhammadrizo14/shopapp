  ...
  <header class="header">
    <div class="container header__wrapper">
      <div class="header__logo_wrapper">
        <router-link to="/"><h1 class="logo__header">Eleanor</h1></router-link>
      ...
      <div class="header__list_wrapper">
        <ul class="header__list">
          ...
          <li>
            <router-link to="/cart"
              ><div class="header__button header__mobile_hide">
                <svg
                  width="32"
                  height="29"
                  viewBox="0 0 32 29"
    ...
    <nav v-if="isActiveMenu == true" class="header__navigation">
      <svg 
        width="13"
        height="13"
        viewBox="0 0 13 13"
